...
import { additionalLinks, defaultLinks } from "src/config/nav";
...
const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={`hover:bg-popover hover:text-primary text-muted-foreground group inline-block rounded-md p-2 text-xs transition-colors hover:shadow w-full${
